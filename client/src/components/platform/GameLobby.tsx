...
export const GameLobby: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900' : 'bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100'} text-white transition-all duration-300`}>
      {/* Header */}
      <div className="bg-black/30 backdrop-blur-sm p-6">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div>
            ...
            {!isOnline && (
              <div className="mt-2 text-red-400 text-sm">⚠️ You're offline - some features may be limited</div>
            )}
          </div>
        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black/20 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="opacity-80">No downloads required. Play directly in your browser with optimized performance.</p>
            </div>
            <div className="bg-black/20 backdrop-blur-sm rounded-lg p-6">
              <div className="text-3xl mb-3">🔒</div>
              <h3 className="text-xl font-bold mb-2">Fair Gaming</h3>
              <p className="opacity-80">Provably fair algorithms ensure transparent and trustworthy gameplay.</p>
            </div>
            <div className="bg-black/20 backdrop-blur-sm rounded-lg p-6">
              <div className="text-3xl mb-3">🎯</div>
              <h3 className="text-xl font-bold mb-2">Multiple Games</h3>
              <p className="opacity-80">Choose from roulette, poker, and more exciting games coming soon.</p>
            </div>
          </div>
        </div>
      </div>
